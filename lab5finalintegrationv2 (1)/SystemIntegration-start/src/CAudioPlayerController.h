...
private:
	 ...
	 */
	int _chooseFilterFile(string &chosenFile, string filePath =".\\files\\filters\\", string fileExt = ".txt");
	 ...
	 */
	uint16_t _getFiles(string path, string ext, string *filelist, uint16_t maxNumFiles);
};
